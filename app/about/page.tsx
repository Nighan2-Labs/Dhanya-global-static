        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                <Users className="w-12 h-12 text-golden-honey mx-auto mb-4" />
                <div className="text-3xl font-bold text-white mb-2">10,000+</div>
                <div className="text-cream-white/80 font-medium">Happy Customers</div>
              </motion.div>
              ...
              <motion.div
                ...
                className="text-center p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300"
              >
                <Leaf className="w-12 h-12 text-golden-honey mx-auto mb-4" />
                <div className="text-3xl font-bold text-white mb-2">100%</div>
                <div className="text-cream-white/80 font-medium">Organic Products</div>
              </motion.div>
              ...
              <motion.div
                ...
                className="text-center p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300"
              >
                <Award className="w-12 h-12 text-golden-honey mx-auto mb-4" />
                <div className="text-3xl font-bold text-white mb-2">15+</div>
                <div className="text-cream-white/80 font-medium">Certifications</div>
              </motion.div>
              ...
              <motion.div
                ...
                className="text-center p-6 bg-white/10 backdrop-blur-sm rounded-2xl border border-white/20 hover:bg-white/20 transition-all duration-300"
              >
                <Heart className="w-12 h-12 text-golden-honey mx-auto mb-4" />
                <div className="text-3xl font-bold text-white mb-2">5 Years</div>
                <div className="text-cream-white/80 font-medium">Trust & Quality</div>
              </motion.div>
            </motion.div>
          </div>
        </div>
